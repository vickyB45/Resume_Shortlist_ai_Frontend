      ...
      <div className="flex justify-end mb-4 space-x-2 fixed top-4 w-[90vw]">
        <button
          ...
          className={`px-4 py-2 rounded-lg  ${
            view === "card" ? "bg-purple-600 text-white" : "bg-white text-gray-700 cursor-pointer"
          }`}
        >
          Card View
        </button>
        <button
          ...
          className={`px-4 py-2 rounded-lg  ${
            view === "table" ? "bg-purple-600 text-white" : "bg-white text-gray-700 cursor-pointer"
          }`}
        >
          Table View
        </button>
  ...
  resumes.length === 0 && (
    <div className="h-screen flex flex-col justify-center items-center text-gray-500">
      ...
      <p className="text-center max-w-xs">
        It looks like you haven’t uploaded any resumes yet. Start by adding some resumes to see your history here!
      </p>
    </div>
  )
}
                ...
                ? Array(6)
                    ...
                    .map((_, i) => (
                      <tr key={i} className="animate-pulse">
                        <td className="py-2 px-4 h-6 bg-gray-300 rounded mb-1"></td>
                        <td className="py-2 px-4 h-6 bg-gray-300 rounded mb-1"></td>
                        <td className="py-2 px-4 h-6 bg-gray-300 rounded mb-1"></td>
                        <td className="py-2 px-4 h-6 bg-gray-300 rounded mb-1"></td>
                      </tr>
